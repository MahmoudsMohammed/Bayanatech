...
export class AccountsGuideComponent implements OnInit {
  ...
  onAccountCodeClick(element: any) {
    this.acountCode2 = element.accountCode;
    this.accountNameAR = element.accountNameAR;
    this.accountNameLat = element.accountNameLat;

    // console.log(this.acountCode2);
    // console.log(this.accountNameAR);
    // console.log(this.accountNameLat);
  }
  ngAfterViewInit() {
  ...
  changeRequestStatus(event: any) {
    this.modalDetails.Creditor = event.target.checked;
  }
  changeRequestStatus2(event: any) {
    this.modalDetails.active = event.target.checked;
  }
