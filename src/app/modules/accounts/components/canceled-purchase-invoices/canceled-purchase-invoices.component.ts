...
@Component({
  selector: 'app-canceled-purchase-invoices',
  templateUrl: './canceled-purchase-invoices.component.html',
  styleUrls: ['./canceled-purchase-invoices.component.scss']
})

export class CanceledPurchaseInvoicesComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.projects = [
      {
        returnNumber: '000056',
        InvoiceCancellationDate: '2023-06-13',
        invoiceNumber: 'أجل',
        PaymentType: 50,
